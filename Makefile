...
main: src/libfacerecognition.cpp src/embed_database.cpp src/stats.cpp src/face_recognition.cpp
	$(CXX) src/stats.cpp src/libfacerecognition.cpp $(CXXFLAGS) $(INCLUDES) $(LIBS) -o stats.out
	$(CXX) src/embed_database.cpp src/libfacerecognition.cpp $(CXXFLAGS) $(INCLUDES) $(LIBS) -o embed_database.out
